...
# page configure
st.set_page_config(page_icon = "🚕🚓", layout = "wide", page_title = "Automobile Analysis")
...
st.markdown('''This app is analyzing the automata data.🚗🚓🚕''')
...
if options == "numerical":
    col2.dataframe(df.describe(include = 'number'), use_container_width = True)
elif options == 'textual':    
    col2.dataframe(df.describe(include = 'object'), use_container_width = True)
